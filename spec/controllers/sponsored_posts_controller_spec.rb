...
RSpec.describe SponsoredPostsController, type: :controller do
  ...
  describe "SPONSORED POST create" do
    ...
    it "redirects to the new sponsored post" do
      post :create, topic_id: my_sponsored_post.id, sponsored_post: {title: RandomData.random_sentence, body: RandomData.random_paragraph, price: RandomData.random_integer}
